...
class CirFixBenchmark(Benchmark.Benchmark):
    ...
    def test(self, srcFiles=None, tbFile=None):
        ...
        simCommand = "timeout {} vcs -sverilog +vc -Mupdate -line -full64 {} {} -o simv -R -LDFLAGS -Wl,--no-as-needed".format(self.bugInfoDict["timeout"], tbFile, " ".join(srcFiles))
